...
export default function App() {
  ...
  async function handlConnect() {
    ...
    try 
      ...
      alert('Wallet conection failed — check console and ensure a compatible wallet extension is installed and popups are allowed.')
    }
  }
      ...
      <main>
        <div className="mb-4">
          <div className="flex gap-2">
            <input id=nwaddr" placeholder="Enter STX address to track" className="p-2 rounded-md bg-slate-800 border border-slate-700 flex-1" />
            <buttonlassName="bn" onClick={() => {
